...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "След покупката и инсталацията ви предоставяме обучение за работа с машината и интерфейса ѝ. Поддръжката включва дистанционна техническа помощ, наличието на резервни части и сервиз в рамките на гаранционния период. Поддръжката включва дистанционна техническа помощ и поръчка на резервни части.",
  },
  {

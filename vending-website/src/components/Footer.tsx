        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            >
              ...
              <span className="font-brand text-lg tracking-[0.25em]">
                BLOOMBOX VENDING
              </span>
            </button>
          ...
          {/* Contacts */}
          <div>
            <h3 className="font-playfair mb-4 text-lg font-semibold">
              Контакти
            </h3>
            <div className="space-y-3">
              ...
              >
                ...
                <span>+359 877 630 860</span>
              </a>
              <a
                href="mailto:office@bloombox.bg"
                className="font-playfair flex items-center gap-3 text-white/80 hover:text-white transition-colors"
              >
                <Mail className="w-5 h-5" />
                <span>office@bloombox.bg</span>
              </a>
              ...
              <div className="flex items-center gap-4 pt-4">
                <a
                  href="https://www.facebook.com/BloomBox.bg"
                  target="_blank"
                ...
                <a
                  href="https://www.instagram.com/bloombox.bg/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center hover:bg-white/20 transition-colors"
